    ...
    <div style={{ 
      ...
      <div style={{
        ...
        <div style={{ marginBottom: '40px', padding: '20px', backgroundColor: '#f9f9f9', borderRadius: '5px' }}>
          <h2 style={{ color: '#555', marginBottom: '15px' }}>Test 1: Our Video (DDlZTTih95c) - Simple iframe (same as homepage)</h2>
          <iframe 
        ...
        <div style={{ marginBottom: '40px', padding: '20px', backgroundColor: '#f9f9f9', borderRadius: '5px' }}>
          <h2 style={{ color: '#555', marginBottom: '15px' }}>Test 3: Different Video (C8Cp5VvvNG6) - Simple iframe</h2>
          <iframe 
