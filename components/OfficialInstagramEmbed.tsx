...
export default function OfficialInstagramEmbed() {
  useEffect(() => {
    ...
    // If Instagram global is already loaded, process embeds
    if (window.instgrm) {
  ...
  return (
    <div style={{ width: '100%', maxWidth: '540px', margin: '0 auto' }}>
      <blockquote 
        ...
        data-instgrm-permalink="https://www.instagram.com/reel/DDlZTTih95c/?utm_source=ig_embed&amp;utm_campaign=loading" 
      ...
      >
        <div style={{ padding: '16px' }}>
          <a 
            href="https://www.instagram.com/reel/DDlZTTih95c/?utm_source=ig_embed&amp;utm_campaign=loading" 
            style={{ 
              background: '#FFFFFF',
              lineHeight: 0,
              padding: '0 0',
          ...
          <p style={{ 
            ...
            <a 
              ...
              rel="noopener noreferrer"
            >
              A post shared by The Waldorf Phuket (@waldorfphuket)
            </a>
          </p>
        </div>
      </blockquote>
